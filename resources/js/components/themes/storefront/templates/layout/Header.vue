        ...
        <div class="z-home-nav container-fluid px-md-5">
            <div class="row align-items-center mx-0">
                ...
                <div class="col-xl-2 col-6 order-xl-3 order-2 navbar-cart-account text-end">
                    ...
                    <button class="btn d-md-none d-inline-block text-white me-3 border" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvas-menu-primary" aria-controls="offcanvas-menu-primary">
